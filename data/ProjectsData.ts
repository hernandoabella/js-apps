export const projectsData = [
  ...
  },
  {
    id: 25,
    name: "Calculadora de edad 🎂",
    description: "Descubre la edad de una persona al ingresar su fecha de nacimiento en esta práctica calculadora. ¡Celebra los cumpleaños y planifica eventos de manera eficiente!",
    category: "Calculadora",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
