export const projectsData = [
  ...
  // },
  {
    ...
    description: "Mantén un registro preciso del número de caracteres en tus textos con este práctico contador. Útil para escribir mensajes, publicaciones en redes sociales y mucho más.",
    category: "Contador",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Esta aplicación te permite evaluar tu velocidad y precisión al escribir. Pon a prueba tus habilidades de mecanografía y comprueba qué tan rápido y preciso puedes escribir diferentes textos.",
    category: "Teclado",
    difficulty: 4,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    id: 26,
    name: "Calendario 📅",
    description: "Mantén un registro organizado de tus eventos, reuniones y actividades diarias con este calendario interactivo. Nunca te pierdas una fecha importante nuevamente.",
    category: "Tiempo",
    difficulty: 3,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    id: 27,
    name: "Caja modal 📦",
    description: "Agrega interacción y estilo a tu sitio web con una caja modal. Muestra información adicional, imágenes o solicitudes de confirmación de manera elegante y fácil de usar.",
    category: "Caja modal",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Asegúrate de que tu aplicación o sitio web esté conectado a Internet con esta útil herramienta de verificación de conexión. Mantén a tus usuarios informados y brinda una experiencia sin interrupciones.",
    category: "Validación",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Valida la autenticidad y el formato correcto de las direcciones de correo electrónico con esta herramienta de validación. Asegura una comunicación efectiva y sin errores con tus usuarios.",
    category: "Validación",
    difficulty: 3,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Evalúa la fortaleza y seguridad de las contraseñas con esta calculadora de fuerza de contraseñas. Ayuda a los usuarios a proteger sus cuentas y datos personales.",
    category: "Validación",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Identifica y obtén información sobre el navegador web utilizado por los usuarios de tu sitio web con esta aplicación. Adapta tu contenido y funcionalidad según las características del navegador.",
    category: "Navegador",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  // },
  {
    ...
    description: "Sumérgete en el espíritu de Halloween con esta aplicación llena de diversión y emocionantes actividades temáticas. Disfruta de juegos, disfraces virtuales y más sorpresas espeluznantes.",
    category: "Halloween",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "on a prueba tu habilidad y destreza con esta divertida aplicación de arrastrar y soltar. Completa desafíos y resuelve puzzles moviendo elementos en la pantalla.",
    category: "Entretenimiento",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Haz girar la ruleta y añade emoción a tus juegos y actividades con esta aplicación interactiva. Personaliza los sectores de la ruleta y observa cómo gira para seleccionar al azar un ganador, una pregunta o cualquier otra opción.",
    category: "Juegos",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Tomar decisiones puede ser difícil, pero esta aplicación te ayuda a elegir entre tres opciones. Ingresa tus preferencias y descubre la mejor opción para ti: ¿Bueno, barato o rápido? Encuentra el equilibrio perfecto para tus necesidades.",
    category: "Extra",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Disfruta de una experiencia personalizada al ordenar pizzas con este sistema intuitivo. Selecciona tus ingredientes favoritos, el tamaño de la pizza y personaliza tu pedido. ¡Satisface tus antojos y disfruta de una deliciosa pizza hecha a tu medida!",
    category: "Extra",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Organiza tus elementos de manera intuitiva con esta lista ordenable. Arrastra y suelta elementos para cambiar su orden y reorganizar tu contenido. Simplifica la gestión de listas y mejora la experiencia del usuario al permitirles personalizar su disposición.",
    category: "Extra",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  // },
  {
    ...
    description: "Esta aplicación te permite crear y realizar encuestas de satisfacción para obtener comentarios y opiniones de los usuarios.",
    category: "Extra",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Esta aplicación te permite filtrar y buscar usuarios en una lista según diferentes criterios.",
    category: "Extra",
    difficulty: 2,
    downloadLink: "#",
    githubLink: "#",
