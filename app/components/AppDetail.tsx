...
import { FaHtml5, FaCss3, FaArrowCircleLeft, FaJs, FaCopy, FaDownload, FaGithub } from "react-icons/fa";
...
const codeSnippets = {
  ...
  js: `<pre><code class="language-javascript hljs">console.log('Hello, World!');</code></pre>`,
};
        ...
        <div className="lg:mx-20 lg:flex-col">
          ...
          <div className="bg-sky-500 p-5 rounded-b-xl md:flex justify-between gap-5">
            <div className="">
              ...
              <div className="mb-2">
                <p>This app allows you to {app.name.toLowerCase()}.</p>
              </div>
            </div>
