...
const AppDetail: React.FC<Props> = ({ name, iframeSrc }) => {
    ...
    if (navigator.clipboard) {
      navigator.clipboard
        ...
        .catch((err) => {
          ...
          alert(
            "Failed to copy code snippet. Please copy it manually."
          );
        });
    } else {
          ...
          <div className="bg-sky-500 p-5 rounded-b-xl md:flex justify-between gap-5">
            ...
            <div className="flex items-center justify-center gap-5">
              <div className="pt-5 md:pt-0">
                <a
                  href={`https://github.com/hernandoabella/${name.toLowerCase().replace(/\s+/g, "-")}.zip`}
                  target="_blank"
              ...
              <div className="pt-5 md:pt-0">
                <a
                  href={`https://github.com/hernandoabella/${name.toLowerCase().replace(/\s+/g, "-")}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-500"
                  download
