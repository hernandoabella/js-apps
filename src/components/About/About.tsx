    ...
    <div className="bg-white py-20 px-4 sm:px-6 md:px-16">
      ...
      <div className="flex flex-col items-center justify-between mt-20 md:flex-row">
        <div className="mb-4 sm:mb-0 sm:mr-4 flex flex-col items-center">
          <Image src="/icon1.png" alt="Icono 1" width={100} height={100} className="mb-5" />
          <p className="text-gray-500">Aprender haciendo. Construye muchos proyectos pequeños y medianos para mejorar tus habilidades.</p>
        </div>
        <div className="mb-4 sm:mb-0 sm:mx-4 flex flex-col items-center">
          <Image src="/icon2.png" alt="Icono 2" width={100} height={100} className="mb-5" />
          <p className="text-gray-500">Selecciona uno de los proyectos sugeridos aquí para aprender algo nuevo o reutilizar técnicas ya aprendidas.</p>
        </div>
        <div className="flex flex-col items-center">
          <Image src="/icon3.png" alt="Icono 3" width={100} height={100} className="mb-5" />
          <p className="text-gray-500">JS-APPS desafía a los desarrolladores a practicar la sintaxis de JavaScript mediante la creación de proyectos.</p>
        </div>
      </div>
    </div>
  );
