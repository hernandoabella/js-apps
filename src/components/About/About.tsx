...
const About = () => {
  ...
  <div className="flex flex-col items-center justify-between mt-20 md:flex-row">
    <div className="mb-4 sm:mb-0 sm:mr-4 flex flex-col items-center">
      ...
      <h4 className="text-xl font-bold m-5">Aprender haciendo</h4>
    ...
    <div className="flex flex-col items-center">
      ...
      <h4 className="text-xl font-bold m-5">Desafía tu habilidad</h4>
      <p className="text-lg text-gray-500">JS-APPS desafía a los desarrolladores a practicar la sintaxis de JavaScript mediante la creación de proyectos.</p>
    </div>
  </div>
</div>
