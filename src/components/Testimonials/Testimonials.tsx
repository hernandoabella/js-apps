      ...
      <div className="flex justify-center flex-wrap">
        <div className="bg-white rounded-lg shadow-md mx-4 my-8 p-8 w-80">
          ...
          <div className="flex items-center">
            <Image src="/path/to/customer1-avatar.jpg" alt="Customer 1" width={60} height={60} className="rounded-full mr-3" />
            <div>
        ...
        <div className="bg-white rounded-lg shadow-md mx-4 my-8 p-8 w-80">
          ...
          <div className="flex items-center">
            <Image src="/path/to/customer2-avatar.jpg" alt="Customer 2" width={60} height={60} className="rounded-full mr-3" />
            <div>
        ...
        <div className="bg-white rounded-lg shadow-md mx-4 my-8 p-8 w-80">
          ...
          <div className="flex items-center">
            <Image src="/path/to/customer3-avatar.jpg" alt="Customer 3" width={60} height={60} className="rounded-full mr-3" />
            <div>
